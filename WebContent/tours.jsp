...
<html>
    ...
    <body>
        ...
        <div class="card-container">
            <a href="persona5.html" class="card-link-wrapper">
              <div class="card">
            ...
            <a href="kon.html" class="card-link-wrapper">
              <div class="card">
                <img class="card-img" src="/AniTour/images/kon1.jpg" alt="kon">
                <div class="card-img-overlay"></div>
                <div class="card-title">
                  k-on
                </div>
            ...
            <a href="vinlandsaga.html" class="card-link-wrapper">
              <div class="card">
                <img class="card-img" src="/AniTour/images/vinland saga1.jpg" alt="vinland">
                <div class="card-img-overlay"></div>
                <div class="card-title">
                  vinland saga
                </div>
